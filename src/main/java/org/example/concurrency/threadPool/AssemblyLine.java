...
public class AssemblyLine {
    ...
    private static final int SLOW_DOWN_PRODUCER_MS = 2 * 1000;
    ...
    private static class Consumer implements Runnable {
        ...
        @Override
        public void run() {
            while (runningConsumer && !queue.isEmpty() ||
                    nrOfConsumers.get()==1) {
                try {
                    String bulb = queue.poll(MAX_CONS_TIME_MS+extraProdTime,TimeUnit.MILLISECONDS);
    ...
    public static void monitorQueueSize(){
